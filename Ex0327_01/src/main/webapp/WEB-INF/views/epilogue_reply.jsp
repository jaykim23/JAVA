...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="mypage">
					<h2><strong>댓글 작성</strong><span>쟈뎅 제품을 구매하신 회원님들의 소중한 후기입니다.</span></h2>
					...
					<div class="checkDivTab">
						<table summary="분류, 구매여부, 작은이미지, 평가, 제목, 상세 내용 순으로 포토 구매후기를 작성 하실수 있습니다." class="checkTable" border="1" cellspacing="0">
							...
							<form action="reply.do" name="replyForm" method="post" enctype="multipart/form-data">
									...
									<input type="hidden" class="wlong" name="bName" value="${session_nName}" />
							<tbody>
								<tr>
								...
								<tr>
									...
									<td>
										<input type="file" class="fileType" name="fileName" value="${dto.fileName}"/>
									</td>
								</tr>
								<tr>
										...
										<ul class="pta">
											<li>
												...
												<label for="starFive" class="star">
													...
													<img src="images/ico/ico_star.gif" alt="별점" />
													<i
													mg src="images/ico/ico_star.gif" alt="별점" />
													<img src="images/ico/ico_star.gif" alt="별점" />
													<img src="images/ico/ico_star.gif" alt="별점" />
												</label>
											</li>
								...
								<tr>
									...
									<td>
										<input type="text" class="wlong" name="bTitle" value="└▶[답글]" />
									</td>
								</tr>
								<tr>
									<th scope="row"><span>상세 내용</span><br></th>
									<td>
										<c:out value="[본문이미지]"></c:out>
										<img src="upload/${dto.fileName}" width="100" height="75"/>
										<textarea class="tta" name="bContent" style="width:150;overflow:hidden;text;overflow:ellipsis;white;space:nowrap">
${dto.bContent}"
-----------------------------------------------
[${dto.bId}번 게시물의 답글]:  
										</textarea>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>																
								<li><a href="content_view.do?category=${category}&search=${search}&page=${page}&bId=${dto.bId}" class="nbtnbig">취소</a></li>
								<li><a onclick="replySubmit()" class="sbtnMini cursor">확인</a></li><!-- 커서는 스타일 -->

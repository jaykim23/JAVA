...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="mypage">
					<h2><strong>게시글 수정</strong><span>쟈뎅 제품을 구매하신 회원님들의 소중한 후기입니다.</span></h2>
					...
					<form action="modify.do" name="modifyForm" method="post" enctype="multipart/form-data">
						<table summary="분류, 구매여부, 작은이미지, 평가, 제목, 상세 내용 순으로 포토 구매후기를 작성 하실수 있습니다." class="checkTable" border="1" cellspacing="0">
							...
							<col width="*" />
							      ...
							      <input type="hidden" name="page" value="${page}">
    								<input type="hidden" name="bId" id="bId" value="${dto.bId}">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="file" class="fileType" name="fileName" value="${dto.fileName}" style="margin:3px;"/><br>
											<c:out value="${dto.fileName}">
											</c:out>												
										
										<p> </p><br>
										<span>
											<img alt="" src="upload/${dto.fileName}" width="75" height="75">
										</span>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<input type="text" class="wlong" name="bTitle" value="${dto.bTitle}"/>
								...
								<tr>
									...
									<td>
										<textarea class="tta" name="bContent"> ${dto.bContent}</textarea>
									</td>
								</tr>	
							</tbody>
						</table>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>																
								...
								<li><a onclick="submit()" class="sbtnMini cursor">확인</a></li><!-- 커서는 스타일 -->
